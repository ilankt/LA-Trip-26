...
var OVERVIEW_STOPS = [
  ...
  { lat:34.0773, lng:-118.4733, num:'2',   tip:'<b>Getty Center</b><br>Day 2 &bull; 1200 Getty Center Dr' },
  { lat:34.0635, lng:-118.3608, num:'3',   tip:'<b>Academy Museum</b><br>Day 3 &bull; 6067 Wilshire Blvd' },
  { lat:34.1184, lng:-118.3004, num:'3',   tip:'<b>Griffith Observatory</b><br>Day 3 &bull; 2800 E Observatory Rd' },
  { lat:34.0371, lng:-118.6767, num:'4',   tip:'<b>Malibu Farm</b><br>Day 4 &bull; lunch on the pier' },
  { lat:34.0380, lng:-118.8747, num:'4',   tip:'<b>El Matador Beach</b><br>Day 4 &bull; sea stacks &amp; cave' },
  { lat:34.4133, lng:-119.6900, num:'SB',  tip:'<b>Hotel Californian</b><br>Nights 4–5 &bull; 36 State St, Santa Barbara', hotel:true },
  { lat:34.4383, lng:-119.7141, num:'6',   tip:'<b>Old Mission SB</b><br>Day 6 &bull; 2201 Laguna St' },
  { lat:34.6697, lng:-120.1155, num:'5',   tip:'<b>Los Olivos</b><br>Day 5 &bull; wine village, Los Olivos' },
  ...
  { lat:33.9965, lng:-118.4577, num:'8',   tip:'<b>Venice / Gjusta</b><br>Day 8 &bull; 320 Sunset Ave &mdash; then LAX' },
];

var DAY_CONFIGS = [
  { id:'map-day-1', zoom:13,
    pins:[{ lat:34.0089,lng:-118.4973,label:'Santa Monica' }] },
  { id:'map-day-2', zoom:14,
    pins:[{ lat:34.0773,lng:-118.4733,label:'The Getty Center' }] },
  { id:'map-day-3',
    pins:[{ lat:34.0635,lng:-118.3608,label:'Academy Museum' },
          { lat:34.1184,lng:-118.3004,label:'Griffith Observatory' }] },
  { id:'map-day-4',
    pins:[{ lat:34.0371,lng:-118.6767,label:'Malibu Farm Pier Cafe' },
          { lat:34.0380,lng:-118.8747,label:'El Matador Beach' },
          { lat:34.4133,lng:-119.6900,label:'Hotel Californian, SB' }],
    route: PCH_PATH.slice(0, 15) },
  { id:'map-day-5',
    pins:[{ lat:34.6697,lng:-120.1155,label:'Los Olivos' },
          { lat:34.6672,lng:-120.1147,label:'Refugio Ranch' }] },
  { id:'map-day-6',
  ...
  { id:'map-day-8', zoom:14,
    pins:[{ lat:33.9965,lng:-118.4577,label:'Venice / Gjusta' }] },
];
